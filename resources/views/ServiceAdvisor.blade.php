    ...
    <div class="container">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-lg text-gray-600">Data Service Advisor</p>
            </div>
            <div>
                <a href="{{route('service-advisor.create')}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Tambahkan Data
                </a>
            </div>
        </div>
                ...
                <div class="w-full overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="bg-white">
                            @foreach ($serviceAdvisors as $index => $man)
