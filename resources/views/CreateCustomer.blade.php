...
@section('content')
    ...
    <div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
        <div class="container max-w-screen-lg mx-auto">
            <div>
                <h2 class="font-semibold text-xl text-gray-600">Service Advisor Form</h2>
                <p class="text-gray-500 mb-6">Tambahkan data untuk service Advisor</p>
                ...
                <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                        ...
                        <div class="lg:col-span-2">
                            <form action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data" class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                @csrf
                                <div class="md:col-span-5">
                                    <label for="name">Nama Sales Man</label>
                                ...
                                <div class="md:col-span-5">
                                    ...
                                    <input type="text" name="phone_number_cust" id="phone_number"
                                        class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value=""
                                        placeholder="+628.." />
                                </div>
                                ...
                                <div class="md:col-span-5">
                                    ...
                                    <input type="text" name="address_cust" id="phone_number"
                                        class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value=""
                                        placeholder="Jln. Raya Gap....." />
                                </div>
                                <div class="md:col-span-5">
                                    <label for="photo">Foto</label>
                                    <input type="file" name="photo_cust" id="photo"
                                        class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" accept="image/*"
                                        onchange="previewImage(event)" />
                                </div>
                                <div class="md:col-span-5">
                                    <img id="photo_preview" src="" alt="Photo Preview" class="mt-2"
                                ...
                                <div class="md:col-span-5 text-right">
                                    <div class="inline-flex items-end">
                                        <button
                                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" type="submit">Submit</button>
                                    </div>
                                </div>
