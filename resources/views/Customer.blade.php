    ...
    <div class="container">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-lg text-gray-600">Data Customer</p>
            </div>
            <div>
                                ...
                                <tr class="text-gray-700">
                                    <td class="px-4 py-3 border">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <p class="font-semibold text-black">{{ $customer->name }}</p>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-sm border">{{ $customer->phone_number_cust }}</td>
                                    <td class="px-4 py-3 text-sm border">{{ $customer->address_cust }}</td>
                                    <td class="py-2 px-4">
