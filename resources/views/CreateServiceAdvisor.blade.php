                ...
                <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                        ...
                        <div class="lg:col-span-2">
                            <form action="{{ route('service-advisor.store') }}" method="POST" enctype="multipart/form-data" class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                @csrf
                                <div class="md:col-span-5">
                                    <label for="name">Nama Service advisor</label>
