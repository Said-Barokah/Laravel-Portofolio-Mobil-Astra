...
@section('content')
    ...
    <div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
        <div class="container max-w-screen-lg mx-auto">
            <div>
                <h2 class="font-semibold text-xl text-gray-600">Sales-Man Form</h2>
                <p class="text-gray-500 mb-6">Tambahkan data untuk sales-man</p>
                ...
                <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                        ...
                        <div class="lg:col-span-2">
                            <form action="{{ route('sales-man.store') }}" method="POST" enctype="multipart/form-data" class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                @csrf
