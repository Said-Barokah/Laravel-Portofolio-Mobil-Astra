...
@section('content')
    <div class="container">
        ...
        <div class="flex w-full justify-end items-center my-2">
            <a href="{{ route('customer.create') }}" class="bg-blue-500 flex space-x-3 justify-center items-center p-1">
                <p class="text-white font-semibold text-lg rounded-md p-2">+ Tambah customer</p>
            </a>
        </div>
            ...
            <tbody class="bg-blue-50">
                @foreach ($customers as $index => $customer)
                    <tr class="text-center">
                        ...
                        <!-- Tipe Mobil -->
                        <td class="ml-2 align-middle text-left">{{ $customer->name }}</td>

                        <!-- Nomor Mesin -->
                        <td class="ml-2 align-middle text-left">{{ $customer->phone_number_cust }}</td>
