...
@section('content')
    <div class="container">
        ...
        <div class="flex w-full justify-end items-center my-2">
            <a href="{{ route('admin.create') }}" class="bg-blue-500 flex space-x-3 justify-center items-center p-1">
                <p class="text-white font-semibold text-lg rounded-md p-2">+ Tambah admin</p>
            </a>
        </div>
            ...
            <tbody class="bg-blue-50">
                @foreach ($admins as $index => $admin)
                    <tr class="text-center">
                        ...
                        <!-- Tipe Mobil -->
                        <td class="ml-2 align-middle text-left">{{ $admin->name }}</td>

                        <!-- Nomor Mesin -->
                        <td class="ml-2 align-middle text-left">{{ $admin->phone_number }}</td>
