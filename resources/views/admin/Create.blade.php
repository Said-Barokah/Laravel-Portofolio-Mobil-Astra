    ...
    <div class="container">
        ...
        <form action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex flex-col space-y-3">
                ...
                <input name="email" id="email" type="email" class="w-full border-2 border-gray-200 rounded-lg p-3 text-gray-700" required/>
            </div>
            <div class="flex flex-col space-y-3">
                <label for="password" class="text-[14px] text-gray-700">Password</label>
                <input name="password" id="password" type="password" class="w-full border-2 border-gray-200 rounded-lg p-3 text-gray-700" required/>
            </div>
            <div class="flex flex-col space-y-3">
                <label for="confirm_password" class="text-[14px] text-gray-700">Konfirmasi Password</label>
                <input name="confirm_password" id="confirm_password" type="password" class="w-full border-2 border-gray-200 rounded-lg p-3 text-gray-700" required/>
